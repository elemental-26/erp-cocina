...
const CHANGELOG = [
  { version: "1.2.0",   fecha: "2026-07-30",   cambios: "Módulo Talento Humano, mejoras administrativas, nuevos componentes de checklist y optimización para tablet." },
...
export const MAX_AREAS_POR_PERSONA = 3;
